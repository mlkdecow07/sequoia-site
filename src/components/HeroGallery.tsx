  ...
  return (
    <>
      <HeroSection images={heroImages}>
        ...
        <div className="relative mx-auto max-w-xl px-1 text-center italic text-white/95 sm:max-w-2xl">
          ...
          {bannerOpen ? (
            <div className="enrollment-banner-enter absolute left-1/2 top-full z-10 mt-8 w-[min(100vw-1rem,64rem)] -translate-x-1/2 px-2 sm:mt-10 sm:px-0 md:mt-12">
              <div className="relative mx-auto w-full max-w-3xl sm:max-w-4xl lg:max-w-5xl">
                <Link
                  href="/enrollment"
